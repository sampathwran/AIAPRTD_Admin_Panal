            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  Text("Price: LKR $price", style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 16, color: Colors.green)),
                  ...
                  Text(address),
                  Text("Coordinates: $lat, $lng", style: const TextStyle(color: Colors.grey)),
                ],
              ),
            ),
          ),
                  ...
                  children: [
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(desc, maxLines: 2, overflow: TextOverflow.ellipsis, style: const TextStyle(color: Colors.grey)),
                              const SizedBox(height: 8),
                              Text("Posted: ${createdAt != null ? DateFormat.yMd().add_jm().format(createdAt.toDate()) : 'Unknown'}"),
                            ],
                          ),
                        ),
                      ],
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        const Spacer(),
                        OutlinedButton.icon(
                          onPressed: () => _updateAdStatus(docs[index].id, 'rejected'),
                        ...
                        ElevatedButton.icon(
                          onPressed: () => _updateAdStatus(docs[index].id, 'approved'),
