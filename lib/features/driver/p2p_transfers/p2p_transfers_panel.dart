  ...
  Widget _buildPendingTab() {
    return StreamBuilder<List<Map<String, dynamic>>>(
      ...
      builder: (context, snapshot) {
        ...
        if (debts.isEmpty) {
          return const Center(
            child: Text("No pending union payments to verify."),
          );
        }
    ...
    try {
      ...
      if (mounted)
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('Payment approved and credited to Savings.'),
          ),
        );
    } catch (e) {
      if (mounted)
  ...
  Future<void> _handleReject(
    ...
    try {
      ...
      if (mounted)
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('Payment rejected. Debtor can re-upload.'),
          ),
        );
    } catch (e) {
      if (mounted)
