...
class P2PTransfersService {
  ...
  Future<void> approveUnionPayment(
    String debtId,
    String creditorId,
    double amount,
  ) async {
    ...
    batch.set(notifRef, {
      ...
      'message':
          'Admin verified the Union payment for your shared trip. Rs.${amount.toStringAsFixed(2)} has been added to your Savings Balance.',
      'targetType': 'specific',
  ...
  Future<void> rejectUnionPayment(
    String debtId,
    String debtorId,
    String reason,
  ) async {
    ...
    batch.set(notifRef, {
      ...
      'message':
          'Your P2P payment slip was rejected by admin. Reason: $reason. Please upload a clear slip.',
      'targetType': 'specific',
