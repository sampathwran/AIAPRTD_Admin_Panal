...
class AddEditBenefitDialog extends StatefulWidget {
  ...
  const AddEditBenefitDialog({super.key, this.benefitDoc});
              ...
              children: [
                ...
                TextFormField(
                  ...
                  decoration: const InputDecoration(
                    ...
                    helperText:
                        'Paste a link to a PNG/SVG image for a full-color icon.',
                  ),
                ),
                const SizedBox(height: 16),
                SwitchListTile(
                  ...
                  subtitle: const Text(
                    'If off, this benefit must be manually granted to specific members.',
                  ),
                  value: _isGlobal,
