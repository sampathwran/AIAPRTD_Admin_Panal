...
class _NotificationsPanelState extends State<NotificationsPanel> {
  ...
  void _sendNotification() async {
    ...
    if (_targetType == 'specific' && _memberIdCtrl.text.trim().isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text("Member ID is required for specific target."),
        ),
      );
      return;
    }
    ...
    try {
      await FirebaseFirestore.instance.collection('notifications').add({
        ...
        'targetMembers': _targetType == 'specific'
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text("Notification successfully queued!")),
        );
      }
    } catch (e) {
      if (mounted) {
                  ...
                  Row(
                    children: [
                      ...
                      Radio(
                        ...
                        onChanged: (v) =>
                            setState(() => _targetType = v.toString()),
                      ),
            ...
            builder: (context, snapshot) {
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final target = data['targetType'] == 'all'
                      ? 'All Members'
                      : 'Member: ${(data['targetMembers'] as List).join(', ')}';
