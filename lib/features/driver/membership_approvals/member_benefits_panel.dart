...
import 'package:aiaprtd_admin_dashboard/core/utils/app_icons_library.dart';
...
class _MemberBenefitsPanelState extends State<MemberBenefitsPanel>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: TabBarView(
        controller: _tabController,
        children: const [ManageGlobalBenefitsTab(), AssignBenefitsTab()],
      ),
    );
  }
}
...
class ManageGlobalBenefitsTab extends StatelessWidget {
  ...
  void _showAddEditDialog(BuildContext context, [DocumentSnapshot? doc]) {
    ...
    final Map<String, dynamic> data = isEdit
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    CheckboxListTile(
                      ...
                      subtitle: const Text(
                        'Check this if every driver should get this benefit automatically.',
                      ),
    ...
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        ...
        builder: (context, snapshot) {
          ...
          if (docs.isEmpty)
            return const Center(child: Text("No global benefits created yet."));
                          ...
                          showDialog(
                            ...
                            builder: (BuildContext context) {
                              return AlertDialog(
                                ...
                                content: Text(
                                  "Are you sure you want to delete '${data['title'] ?? 'this benefit'}'? This action cannot be undone.",
                                ),
                                actions: [
                                  TextButton(
                                    child: const Text("Cancel"),
...
class _AssignBenefitsTabState extends State<AssignBenefitsTab> {
  ...
  void _showAssignDialog(
    ...
    final benefitsSnap = await FirebaseFirestore.instance
        .collection('member_benefits')
        .orderBy('createdAt')
        .get();
      ...
      builder: (context) {
        return StatefulBuilder(
          builder: (context, setState) {
            return AlertDialog(
              title: Text(
                'Assign Benefits: $memberName ($memberNo)',
              ...
              content: SizedBox(
                ...
                child: benefits.isEmpty
                    ? const Text(
                        "No global benefits found. Add them first in the other tab.",
                      )
                    : ListView.builder(
                        shrinkWrap: true,
                ...
                ElevatedButton(
                  ...
                  onPressed: () async {
                    await FirebaseFirestore.instance
                        .collection('member')
                        .doc(memberDoc.id)
                        .update({'grantedBenefits': currentGranted});
                    if (context.mounted) {
                      Navigator.pop(context);
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                          content: Text('Benefits Updated Successfully! ✅'),
                        ),
                      );
                    }
                  },
            ...
            builder: (context, snapshot) {
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final data = doc.data() as Map<String, dynamic>;
                  final grantedList = data['grantedBenefits'] is List
                      ? (data['grantedBenefits'] as List).length
                      : 0;
