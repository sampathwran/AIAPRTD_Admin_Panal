...
class _NewMembersPanelState extends State<NewMembersPanel> {
  ...
  Future<void> _acknowledgeAll(
    List<Map<String, dynamic>> unviewedMembers,
  ) async {
              ...
              children: [
                ...
                ElevatedButton.icon(
                  style: ElevatedButton.styleFrom(
                    backgroundColor: unviewedMembers.isEmpty
                        ? Colors.grey.shade300
                        : const Color(0xFF059669),
                    foregroundColor: unviewedMembers.isEmpty
                        ? Colors.grey
                        : Colors.white,
                  ...
                  onPressed: (unviewedMembers.isEmpty || _isAcknowledgingAll)
                      ? null
                      : () => _acknowledgeAll(unviewedMembers),
                                        ...
                                        itemBuilder: (context, index) {
                                          ...
                                          if (item is String) {
                                            ...
                                            return Container(
                                              ...
                                              child: Text(
                                                isUnviewed
                                                    ? 'UNVIEWED NEW MEMBERS (${unviewedMembers.length})'
                                                    : 'RECENTLY VIEWED (Last 3 days)',
                                                style: TextStyle(
                                                  fontWeight: FontWeight.bold,
                                                  fontSize: 10,
                                                  color: isUnviewed
