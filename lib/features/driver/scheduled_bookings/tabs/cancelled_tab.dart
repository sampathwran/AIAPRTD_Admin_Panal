...
// ═══════════════════════════════════════════════════════════════════════════════
// Cancelled Tab
// Card click → BookingDetailDialog (shows who cancelled + reason)
// ═══════════════════════════════════════════════════════════════════════════════

class CancelledTab extends StatelessWidget {
  final List<QueryDocumentSnapshot> docs;
  const CancelledTab({super.key, required this.docs});
  ...
  Widget build(BuildContext context) {
    if (docs.isEmpty) {
      return const AdminEmptyBookingState(
        ...
        subtitle: 'No trips have been cancelled for this category.',
      );
    }
