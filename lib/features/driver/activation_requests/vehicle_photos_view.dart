    ...
    return GridView.builder(
      ...
      gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
        ...
        childAspectRatio: screenWidth < 600
            ? 1.1
            : 0.8, // Screen එක අනුව ratio එක adjust කරනවා
      ),
                  ...
                  children: [
                    ...
                    Positioned.fill(
                      child: Material(
                        ...
                        child: InkWell(
                          onTap: () =>
                              _showFullImagePreview(context, imageUrl, label),
                          child: Container(
                            ...
                            children: [
                              Expanded(
                                child: OutlinedButton.icon(
                                  ...
                                  onPressed: () =>
                                      _showRejectDialog(context, label),
                                ),
                              ),
                              ...
                              Expanded(
                                child: ElevatedButton.icon(
                                  ...
                                  onPressed: () =>
                                      Provider.of<VehicleRequestProvider>(
                                        context,
                                        listen: false,
