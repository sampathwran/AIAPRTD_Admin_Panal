...
import 'package:aiaprtd_admin_dashboard/features/driver/activation_requests/dashboard_stats.dart';
import 'package:aiaprtd_admin_dashboard/features/driver/activation_requests/request_list.dart';
        ...
        actions: [
          IconButton(
            ...
            onPressed: () async {
              ...
              await Provider.of<VehicleRequestProvider>(
                context,
                listen: false,
          ...
          IconButton(
            ...
            onPressed: () async {
              ...
              if (context.mounted) {
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(
                    content: Text("Stuck vehicles fixed! Check pending list."),
                  ),
                );
              }
            },
