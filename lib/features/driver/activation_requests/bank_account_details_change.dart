...
class BankAccountDetailsChangeRequests extends StatefulWidget {
  ...
  @override
  State<BankAccountDetailsChangeRequests> createState() =>
      _BankAccountDetailsChangeRequestsState();
}

class _BankAccountDetailsChangeRequestsState
    extends State<BankAccountDetailsChangeRequests> {
  @override
  void initState() {
    super.initState();
    WidgetsBinding.instance.addPostFrameCallback((_) {
      Provider.of<ChangeBankDetailsProvider>(
        context,
        listen: false,
      ).startListeningToBankRequests();
    });
  }
  ...
  void _handleApprove(
    ...
    final provider = Provider.of<ChangeBankDetailsProvider>(
      context,
      listen: false,
    );
    ...
    if (success) {
      ...
      scaffoldMessenger.showSnackBar(
        const SnackBar(
          content: Text("Bank Details Approved Successfully! ✅"),
          backgroundColor: Colors.teal,
        ),
      );
    } else {
  ...
  void _handleReject(
    ...
    if (success) {
      ...
      scaffoldMessenger.showSnackBar(
        const SnackBar(
          content: Text("Bank Update Request Rejected! ❌"),
          backgroundColor: Colors.redAccent,
        ),
      );
    } else {
                        ...
                        children: [
                          Expanded(
                            child: OutlinedButton(
                              ...
                              onPressed: () =>
                                  _showRejectDialog(context, membershipNo),
                              child: const Text(
                                "Reject",
                          ...
                          Expanded(
                            child: ElevatedButton(
                              ...
                              onPressed: () => _showEditApproveDialog(
                                context,
                                membershipNo,
                                data,
                              ),
