        ...
        builder: (context, snapshot) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return RequestCard(docId: docs[index].id, data: data);
            },
          );
        },
      ),
...
class RequestCard extends StatelessWidget {
  ...
  const RequestCard({super.key, required this.docId, required this.data});
              ...
              children: [
                ...
                Expanded(
                  child: ElevatedButton.icon(
                    ...
                    onPressed: () =>
                        _handleApproval(context, membershipNo, imageUrl),
                  ),
                ),
              ],
            ),
  ...
  Future<void> _handleRejection(
    ...
    try {
      ...
      batch.set(notificationRef, {
        ...
        'body':
            'Your recent profile photo update was rejected. Reason: $reason. Please upload a clear photo.',
