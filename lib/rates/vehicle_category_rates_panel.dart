...
import 'rate_calculator_view.dart';
import 'active_system_rates_view.dart';

class VehicleCategoryRatesPanel extends StatefulWidget {
  const VehicleCategoryRatesPanel({super.key});

  @override
  State<VehicleCategoryRatesPanel> createState() => _VehicleCategoryRatesPanelState();
}
        ...
        appBar: AppBar(
          ...
          bottom: const TabBar(
            ...
            tabs: [
              ...
              Tab(icon: Icon(Icons.local_taxi_rounded), text: "Active System Rates"),
            ],
          ),
        ),
