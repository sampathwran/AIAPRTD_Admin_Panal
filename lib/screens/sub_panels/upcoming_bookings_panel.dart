...
class _UpcomingBookingsPanelState extends State<UpcomingBookingsPanel> {
                ...
                children: [
                  ...
                  const Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 4),
                      Text('Manage all advance and scheduled bookings', style: TextStyle(color: Colors.grey, fontSize: 13)),
                    ],
                  ),
                ],
              ),
  ...
  Widget _buildEmptyStateForAllTabs() {
    return const TabBarView(
      children: [
        AdminEmptyBookingState(title: "No Upcoming Bookings", subtitle: "There are no upcoming scheduled rides."),
        AdminEmptyBookingState(title: "No Ongoing Bookings", subtitle: "There are no ongoing rides currently."),
        AdminEmptyBookingState(title: "No Completed Bookings", subtitle: "There are no completed rides to show."),
        AdminEmptyBookingState(title: "No Cancelled Bookings", subtitle: "There are no cancelled rides."),
      ],
    );
  }
  ...
  Widget _buildTabBarView(List<QueryDocumentSnapshot> allDocs) {
    ...
    return TabBarView(
      children: [
        _buildBookingGrid(upcomingDocs, "No Upcoming Bookings", "There are no upcoming scheduled rides."),
        _buildBookingGrid(ongoingDocs, "No Ongoing Bookings", "There are no ongoing rides currently."),
        _buildBookingGrid(completedDocs, "No Completed Bookings", "There are no completed rides to show."),
        _buildBookingGrid(cancelledDocs, "No Cancelled Bookings", "There are no cancelled rides."),
      ],
    );
  }

  Widget _buildBookingGrid(List<QueryDocumentSnapshot> docs, String emptyTitle, String emptySubtitle) {
    if (docs.isEmpty) {
