          ...
          children: [
            ...
            Expanded(
              child: memberProvider.isLoading
                  ...
                  ? const Center(
                child: Text('No inactive profiles found.', style: TextStyle(color: Colors.grey, fontSize: 12)),
              )
                  : Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          Container(
                            ...
                            child: const Row(
                              children: [
                                SizedBox(width: 100, child: Text('ID', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 11, color: Colors.orange))),
                                SizedBox(width: 180, child: Text('Full Name', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 11, color: Colors.orange))),
                                SizedBox(width: 120, child: Text('Mobile', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 11, color: Colors.orange))),
                                SizedBox(width: 130, child: Text('Vehicle Number', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 11, color: Colors.orange))),
                                SizedBox(width: 130, child: Text('Type', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 11, color: Colors.orange))),
                                SizedBox(width: 100, child: Text('Status', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 11, color: Colors.orange))),
                              ],
                            ),
                          ),
                          ...
                          Expanded(
                            child: Scrollbar(
                              ...
                              child: ListView.builder(
                                ...
                                itemExtent: 36, // Row එකක උස 36px දක්වා සිහින් කළා
                                itemBuilder: (context, index) {
                                  final driver = filteredMembers[index];
                                  final currentStatus = driver['status'] ?? 'pending';
                                  ...
                                  return Container(
                                    ...
                                    child: Row(
                                      children: [
                                        // ID Column
                                        SizedBox(width: 100, child: Text(driver['membershipNo'] ?? '-', style: const TextStyle(fontWeight: FontWeight.w600, fontSize: 11))),
                                        ...
                                        // Mobile Column
                                        SizedBox(width: 120, child: Text(driver['mobile'] ?? '-', style: const TextStyle(fontSize: 11))),
