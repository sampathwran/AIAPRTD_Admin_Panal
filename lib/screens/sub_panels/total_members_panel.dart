...
class _TotalMembersPanelState extends State<TotalMembersPanel> {
          ...
          children: [
              ...
              children: [
                ...
                const Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 1),
                    Text('Manage and monitor all registered driver profiles', style: TextStyle(color: Colors.grey, fontSize: 10)),
                  ],
                ),
              ],
            ),
            ...
            Expanded(
              child: memberProvider.isLoading
                  ...
                  ? const Center(
                child: Text('No registered members found.', style: TextStyle(color: Colors.grey, fontSize: 12)),
              )
                  : Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            Container(
                              ...
                              child: const Row(
                                children: [
                                  SizedBox(width: 110, child: Text('Membership No', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 11, color: Color(0xFF1E3A8A)))),
                                  SizedBox(width: 180, child: Text('Full Name', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 11, color: Color(0xFF1E3A8A)))),
                                  SizedBox(width: 110, child: Text('NIC No', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 11, color: Color(0xFF1E3A8A)))),
                                  SizedBox(width: 110, child: Text('Mobile', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 11, color: Color(0xFF1E3A8A)))),
                                  SizedBox(width: 120, child: Text('Vehicle No', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 11, color: Color(0xFF1E3A8A)))),
                                  SizedBox(width: 120, child: Text('Vehicle Type', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 11, color: Color(0xFF1E3A8A)))),
                                  SizedBox(width: 110, child: Text('Status', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 11, color: Color(0xFF1E3A8A)))),
                                  SizedBox(width: 50, child: Text('Actions', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 11, color: Color(0xFF1E3A8A)))),
                                ],
                              ),
                            ),
                                    ...
                                    return Container(
                                      ...
                                      child: Row(
                                        children: [
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                CircleAvatar(
                                                  ...
                                                  child: Text(
                                                    (driver['firstName'] ?? 'D').toString().substring(0, 1).toUpperCase(),
                                          ...
                                          SizedBox(width: 110, child: Text(driver['nic'] ?? '-', style: const TextStyle(fontSize: 11))),
                                          ...
                                          SizedBox(width: 120, child: Text(driver['vehicleType'] ?? '-', style: const TextStyle(fontSize: 11))),
                                          SizedBox(
                                            width: 110,
                                            child: Align(
                                              alignment: Alignment.centerLeft,
                                              child: Container(
                                                ...
                                                child: Text(
                                                  (driver['status'] ?? 'pending').toString().toUpperCase(),
                                                  style: TextStyle(
                                                    color: isActive ? Colors.green.shade700 : Colors.amber.shade700,
                                                    fontSize: 8,
                                          ...
                                          SizedBox(
                                            ...
                                            child: Align(
                                              ...
                                              child: IconButton(
                                                ...
                                                constraints: const BoxConstraints(),
                                                onPressed: () {
                                                  _showDriverDetailsDialog(context, driver);
                                                },
                                              ),
                                            ),
                                          ),
  ...
  void _showDriverDetailsDialog(BuildContext context, Map<String, dynamic> driver) {
    showDialog(
      context: context,
            ...
            child: SelectionArea(
              child: Column(
                ...
                children: [
                  Row(
                    children: [
                      const Icon(Icons.person_outline_rounded, color: Color(0xFF1E3A8A), size: 22),
                      const SizedBox(width: 8),
                      Expanded(
                        child: Text(
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          SizedBox(
            width: 130,
            child: Text(label, style: const TextStyle(fontWeight: FontWeight.bold, color: Colors.black54, fontSize: 12)),
          ),
          Expanded(
