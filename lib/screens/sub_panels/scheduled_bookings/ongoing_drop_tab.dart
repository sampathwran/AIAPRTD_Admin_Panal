    ...
    return LayoutBuilder(builder: (context, constraints) {
      ...
      return GridView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          final hasStarted = raw['startedAt'] != null || raw['tripStartTime'] != null;
          if (status == 'arrived' || status == 'ongoing' || status == 'ongoing drop' || ((status == 'accepted' || status == 'ongoing pickup') && hasStarted)) {
            raw['status'] = 'ongoing drop';
          }

          final driverRef = (raw['acceptedBy'] ??
                  raw['driverId'] ??
